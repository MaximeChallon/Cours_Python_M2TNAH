...
def run(query, full, output_file):
    ...
    """
# en faisant python recehrche.py --help dans le terminal, j'obtient la doc dans le terminal de cette fonction run



# je déclare que ce qui suit est une focntion appellable en terminal
@click.command()
@click.argument("query", type=str)
def run(query):# le nom du paramètre doit être le même que celui du dessus
...
# faire dans le terminal python3 recherche.py Edward ; edward étant la chaîne de caractères mise en argument
